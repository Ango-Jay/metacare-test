        ...
        <>
            <div>
                <div className="flex flex-col sm:flex-row pt-6 sm:pl-3 justify-between">
                    ...
                    <div className="relative border border-gray-200 rounded-lg ml-3 mr-16 mt-6 w-[200px] sm:w-auto sm:mt-0">
                        <svg width="175" height="54" viewBox="0 0 175 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path onClick={() => setShowUser(!showUser)} style={{ cursor: "pointer" }} fillRule="evenodd" clipRule="evenodd" d="M151 28.0572L153.862 25.1953C154.122 24.9349 154.544 24.9349 154.805 25.1953C155.065 25.4556 155.065 25.8777 154.805 26.1381L151.471 29.4714C151.211 29.7318 150.789 29.7318 150.529 29.4714L147.195 26.1381C146.935 25.8777 146.935 25.4556 147.195 25.1953C147.456 24.9349 147.878 24.9349 148.138 25.1953L151 28.0572Z" fill="#696D8C" />
                            <rect style={{ display: "none" }} x="5" y="5" width="174" height="53" rx="15" stroke="#ECEBF5" />
                        </svg>
                        <div className="absolute bottom-[-4em] py-3 bg-white flex-col text-left px-1" style={showUser ? {display:"flex"} : {display:"none"}}>
