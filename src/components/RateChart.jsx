...
const RateChart = (props)=>{
            ...
            <div className="flex flex-col sm:flex-row justify-between border border-gray-200 rounded-lg p-3 w-[95%] overflow-x-auto mx-3 my-6">
                <div className="flex flex-col sm:border-r border-gray-200 mr-3 p-3 shrink sm:basis-4/5">
                  ...
                  <div className="flex items-center">
                        <h2 className="font-bold text-left text-xl">First contact resolution rate</h2>
                        <div className="flex items-center justify-center ml-3 mr-3 w-16 h-8 text-sm text-[#25BB87] bg-[#25BB87]/10">+4.14%</div>
                  </div>
                        <div className="flex items-center whitespace-nowrap">
                            <h4 className="text-sm font-bold"><span className="w-[10px] h-[10px] px-1 bg-[#07C9E2] inline-block mr-2"></span>High Priority</h4>
    ...
    >   <Line
            ...
            />
                ...
                <div className="flex flex-row justify-center xs:justify-start  sm:flex-col sm:basis-1/5 w-full sm:w-auto shrink-0 sm:mr-6 mr-0">
